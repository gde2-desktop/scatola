...
/* eel-vfs-extensions.h - gde2-vfs extensions.  Its likely some of these will
                          be part of gde2-vfs in the future.
...
#define EEL_DESKTOP_URI "x-scatola-desktop:"
#define EEL_SEARCH_URI "x-scatola-search:"
