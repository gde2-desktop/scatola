 ...
 * @type_name: the name for the new accessible type eg. ScatolaIconCanvasItemAccessible
 ...
 *      we need to pass GDE2_TYPE_CANVAS_ITEM - since GailCanvasItem is registered against
 *      that type.
