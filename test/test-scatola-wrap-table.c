...
main (int argc, char* argv[])
{
	...
	/* Use scatola_customization to make the emblem widgets */
	customization_data = scatola_customization_data_new ("emblems", TRUE,
							      SCATOLA_ICON_SIZE_SMALL, 
							      SCATOLA_ICON_SIZE_SMALL);
