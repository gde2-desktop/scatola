...
/* scatola-file-management-properties.c - Functions to create and show the scatola preference dialog.
...
#include <libscatola-private/scatola-column-chooser.h>
#include <libscatola-private/scatola-column-utilities.h>
...
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET "default_view_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET "icon_view_zoom_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET "compact_view_zoom_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET "list_view_zoom_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET "sort_order_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET "date_format_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET "preview_text_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET "preview_image_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_SOUND_WIDGET "preview_sound_combobox"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET "preview_folder_combobox"

/* bool preferences */
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET "sort_folders_first_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_COMPACT_LAYOUT_WIDGET "compact_layout_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET "labels_beside_icons_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH "all_columns_same_width_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET "always_use_browser_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_LOCATION_ENTRY_WIDGET "always_use_location_entry_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET "trash_confirm_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET "trash_delete_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET "hidden_files_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET "treeview_folders_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTOMOUNT_OPEN "media_automount_open_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTORUN_NEVER "media_autorun_never_checkbutton"
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_USE_IEC_UNITS_WIDGET "use_iec_units"

/* int enums */
#define SCATOLA_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET "preview_image_size_combobox"
...
static void scatola_file_management_properties_dialog_update_media_sensitivity (GtkBuilder *builder);

static void
scatola_file_management_properties_size_group_create (GtkBuilder *builder,
        char *prefix,
        int items)
{
...
static void
scatola_file_management_properties_dialog_response_cb (GtkDialog *parent,
        int response_id,
        GtkBuilder *builder)
{
    char *section;
    ...
    if (response_id == GTK_RESPONSE_HELP)
    {
        ...
        default:
        case 0:
            section = "gosscatola-438";
            break;
        case 1:
            section = "gosscatola-56";
            break;
        case 2:
            section = "gosscatola-439";
            break;
        case 3:
            section = "gosscatola-490";
            break;
        case 4:
            section = "gosscatola-60";
            break;
        case 5:
            section = "gosscatola-61";
            break;
        }
        preferences_show_help (GTK_WINDOW (parent), "gde2-user-guide", section);
    }
    else if (response_id == GTK_RESPONSE_CLOSE)
    {
        g_signal_handlers_disconnect_by_func (scatola_media_preferences,
                                              scatola_file_management_properties_dialog_update_media_sensitivity,
                                              builder);
    }
}

static void
columns_changed_callback (ScatolaColumnChooser *chooser,
                          gpointer callback_data)
{
    char **visible_columns;
    char **column_order;

    scatola_column_chooser_get_settings (SCATOLA_COLUMN_CHOOSER (chooser),
                                      &visible_columns,
                                      &column_order);

    g_settings_set_strv (scatola_list_view_preferences,
                         SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS,
                         (const char * const *)visible_columns);
    g_settings_set_strv (scatola_list_view_preferences,
                         SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER,
                                ...
                                gpointer user_data)
{
    ...
    g_settings_set_strv (scatola_icon_view_preferences,
                         SCATOLA_PREFERENCES_ICON_VIEW_CAPTIONS,
...
update_icon_captions_from_settings (GtkBuilder *builder)
{
    ...
    captions = g_settings_get_strv (scatola_icon_view_preferences, SCATOLA_PREFERENCES_ICON_VIEW_CAPTIONS);
    if (captions == NULL)
        return;
...
static void
scatola_file_management_properties_dialog_setup_icon_caption_page (GtkBuilder *builder)
{
    GList *columns;
    int i;
    gboolean writable;

    writable = g_settings_is_writable (scatola_icon_view_preferences, SCATOLA_PREFERENCES_ICON_VIEW_CAPTIONS);

    columns = scatola_get_common_columns ();
    ...
    scatola_column_list_free (columns);
...
create_date_format_menu (GtkBuilder *builder)
{
    ...
    combo_box = GTK_COMBO_BOX_TEXT
            (gtk_builder_get_object (builder,
                                     SCATOLA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET));
...
static void
set_columns_from_settings (ScatolaColumnChooser *chooser)
{
    char **visible_columns;
    char **column_order;

    visible_columns = g_settings_get_strv (scatola_list_view_preferences,
                                           SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
    column_order = g_settings_get_strv (scatola_list_view_preferences,
                                        SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);

    scatola_column_chooser_set_settings (SCATOLA_COLUMN_CHOOSER (chooser),
                                      visible_columns,
                                      column_order);
...
static void
use_default_callback (ScatolaColumnChooser *chooser,
                      gpointer user_data)
{
    g_settings_reset (scatola_list_view_preferences,
                      SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
    g_settings_reset (scatola_list_view_preferences,
                      SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);
...
static void
scatola_file_management_properties_dialog_setup_list_column_page (GtkBuilder *builder)
{
    GtkWidget *chooser;
    GtkWidget *box;

    chooser = scatola_column_chooser_new (NULL);
    ...
    set_columns_from_settings (SCATOLA_COLUMN_CHOOSER (chooser));
...
static void
scatola_file_management_properties_dialog_update_media_sensitivity (GtkBuilder *builder)
{
    gtk_widget_set_sensitive (GTK_WIDGET (gtk_builder_get_object (builder, "media_handling_vbox")),
                              ! g_settings_get_boolean (scatola_media_preferences, SCATOLA_PREFERENCES_MEDIA_AUTORUN_NEVER));
}
...
other_type_combo_box_changed (GtkComboBox *combo_box, GtkComboBox *action_combo_box)
{
    ...
    scatola_autorun_prepare_combo_box (GTK_WIDGET (action_combo_box),
                                    x_content_type,
                                    TRUE,
                                    TRUE,
                                    TRUE,
...
extension_state_toggled (GtkCellRendererToggle *cell, gchar *path_str, gpointer data)
{
	...
	if (&iter != NULL)
    {
        ...
        if (scatola_extension_set_state (ext, new_state))
        {
...
static void
scatola_file_management_properties_dialog_setup_media_page (GtkBuilder *builder)
{
    unsigned int n;
    GList *l;
    GList *content_types;
    ...
    {
        scatola_autorun_prepare_combo_box (GTK_WIDGET (gtk_builder_get_object (builder, s[n*2])), s[n*2 + 1],
    ...
    for (l = content_types; l != NULL; l = l->next)
    {
        ...
        if (icon != NULL)
        {
            ...
            g_object_unref (icon);
            pixbuf = scatola_icon_info_get_pixbuf_nodefault_at_size (icon_info, icon_size);
...
skip:
    ...
    scatola_file_management_properties_dialog_update_media_sensitivity (builder);
}

static void
scatola_file_management_properties_dialog_setup_extension_page (GtkBuilder *builder)
{
    ...
    extensions = scatola_extensions_get_list ();
...
static  void
scatola_file_management_properties_dialog_setup (GtkBuilder *builder, GtkWindow *window)
{
    GtkWidget *dialog;

    /* setup UI */
    scatola_file_management_properties_size_group_create (builder,
            "views_label",
            5);
    scatola_file_management_properties_size_group_create (builder,
            "captions_label",
    ...
    /* setup preferences */
    bind_builder_bool (builder, scatola_icon_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_COMPACT_LAYOUT_WIDGET,
                       SCATOLA_PREFERENCES_ICON_VIEW_DEFAULT_USE_TIGHTER_LAYOUT);
    bind_builder_bool (builder, scatola_icon_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET,
                       SCATOLA_PREFERENCES_ICON_VIEW_LABELS_BESIDE_ICONS);
    bind_builder_bool (builder, scatola_compact_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH,
                       SCATOLA_PREFERENCES_COMPACT_VIEW_ALL_COLUMNS_SAME_WIDTH);
    bind_builder_bool (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET,
                       SCATOLA_PREFERENCES_SORT_DIRECTORIES_FIRST);
    bind_builder_bool_inverted (builder, scatola_preferences,
                                SCATOLA_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET,
                                SCATOLA_PREFERENCES_ALWAYS_USE_BROWSER);

    bind_builder_bool (builder, scatola_media_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTOMOUNT_OPEN,
                       SCATOLA_PREFERENCES_MEDIA_AUTOMOUNT_OPEN);
    bind_builder_bool (builder, scatola_media_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTORUN_NEVER,
                       SCATOLA_PREFERENCES_MEDIA_AUTORUN_NEVER);

    bind_builder_bool (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET,
                       SCATOLA_PREFERENCES_CONFIRM_TRASH);

    bind_builder_bool (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET,
                       SCATOLA_PREFERENCES_ENABLE_DELETE);
    bind_builder_bool (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET,
                       SCATOLA_PREFERENCES_SHOW_HIDDEN_FILES);
    bind_builder_bool (builder, scatola_tree_sidebar_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET,
                       SCATOLA_PREFERENCES_TREE_SHOW_ONLY_DIRECTORIES);

    bind_builder_bool (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_USE_IEC_UNITS_WIDGET,
                       SCATOLA_PREFERENCES_USE_IEC_UNITS);

    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET,
                       SCATOLA_PREFERENCES_DEFAULT_FOLDER_VIEWER,
                       (const char **) default_view_values);
    bind_builder_enum (builder, scatola_icon_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET,
                       SCATOLA_PREFERENCES_ICON_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, scatola_compact_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET,
                       SCATOLA_PREFERENCES_COMPACT_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, scatola_list_view_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET,
                       SCATOLA_PREFERENCES_LIST_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET,
                       SCATOLA_PREFERENCES_DEFAULT_SORT_ORDER,
                       (const char **) sort_order_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET,
                       SCATOLA_PREFERENCES_SHOW_TEXT_IN_ICONS,
                       (const char **) preview_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET,
                       SCATOLA_PREFERENCES_SHOW_IMAGE_FILE_THUMBNAILS,
                       (const char **) preview_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_SOUND_WIDGET,
                       SCATOLA_PREFERENCES_PREVIEW_SOUND,
                       (const char **) preview_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET,
                       SCATOLA_PREFERENCES_SHOW_DIRECTORY_ITEM_COUNTS,
                       (const char **) preview_values);
    bind_builder_enum (builder, scatola_preferences,
                       SCATOLA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET,
    ...
    bind_builder_radio (builder, scatola_preferences,
    ...
    bind_builder_radio (builder, scatola_preferences,
                        ...
                        SCATOLA_PREFERENCES_EXECUTABLE_TEXT_ACTIVATION,
                        (const char **) executable_text_values);

    bind_builder_uint_enum (builder, scatola_preferences,
                            SCATOLA_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET,
                            SCATOLA_PREFERENCES_IMAGE_FILE_THUMBNAIL_LIMIT,
                            thumbnail_limit_values,
                            G_N_ELEMENTS (thumbnail_limit_values));

    scatola_file_management_properties_dialog_setup_icon_caption_page (builder);
    scatola_file_management_properties_dialog_setup_list_column_page (builder);
    scatola_file_management_properties_dialog_setup_media_page (builder);
    scatola_file_management_properties_dialog_setup_extension_page (builder);

    g_signal_connect_swapped (scatola_media_preferences,
                              "changed::" SCATOLA_PREFERENCES_MEDIA_AUTORUN_NEVER,
                              G_CALLBACK(scatola_file_management_properties_dialog_update_media_sensitivity),
                              builder);
    ...
    g_signal_connect_data (G_OBJECT (dialog), "response",
                           G_CALLBACK (scatola_file_management_properties_dialog_response_cb),
...
void
scatola_file_management_properties_dialog_show (GCallback close_callback, GtkWindow *window)
{
    GtkBuilder *builder;
    ...
    gtk_builder_add_from_file (builder,
                               UIDIR "/scatola-file-management-properties.ui",
                               NULL);
    ...
    scatola_file_management_properties_dialog_setup (builder, window);
