...
struct FMDirectoryViewClass
{
     ...
     * subclasses to replace (override). Subclasses must replace it
     * with a function that returns a newly-allocated GList of
     * ScatolaFile pointers. The difference from get_selection is
     ...
     * others). The argument is a list of ScatolaFiles. */
    ...
    ScatolaZoomLevel (* get_zoom_level)    (FMDirectoryView *view);
...
ScatolaWindowInfo *fm_directory_view_get_scatola_window              (FMDirectoryView  *view);
ScatolaWindowSlotInfo *fm_directory_view_get_scatola_window_slot     (FMDirectoryView  *view);
char *              fm_directory_view_get_uri                          (FMDirectoryView  *view);
char *              fm_directory_view_get_backing_uri                  (FMDirectoryView  *view);
gboolean            fm_directory_view_can_accept_item                  (ScatolaFile     *target_item,
        const char       *item_uri,
...
ScatolaZoomLevel   fm_directory_view_get_zoom_level                   (FMDirectoryView  *view);
...
ScatolaDirectory  *fm_directory_view_get_model                        (FMDirectoryView  *view);
GtkWindow	   *fm_directory_view_get_containing_window	       (FMDirectoryView  *view);
ScatolaFile       *fm_directory_view_get_directory_as_file            (FMDirectoryView  *view);
...
void                fm_directory_view_init_view_iface                  (ScatolaViewIface *iface);
