...
{
    ScatolaIconContainerClass parent_class;
};

GType                  fm_icon_container_get_type         (void);
ScatolaIconContainer *fm_icon_container_construct        (FMIconContainer *icon_container,
        FMIconView      *view);
ScatolaIconContainer *fm_icon_container_new              (FMIconView      *view);
