...
/* fm-empty-view.c - implementation of empty view of directory.
   ...
   Authors: Christian Neumair <chris@gde2-de.org>
*/
...
static void   fm_empty_view_scroll_to_file                  (ScatolaView      *view,
        const char        *uri);
static void   fm_empty_view_iface_init                      (ScatolaViewIface *iface);
...
static void
fm_empty_view_add_file (FMDirectoryView *view, ScatolaFile *file, ScatolaDirectory *directory)
{
    ...
    g_timer_start (timer);
    icon = scatola_file_get_icon_pixbuf (file, scatola_get_icon_size_for_zoom_level (SCATOLA_ZOOM_LEVEL_STANDARD), TRUE, 0);
...
static void
fm_empty_view_file_changed (FMDirectoryView *view, ScatolaFile *file, ScatolaDirectory *directory)
{
}
...
static void
fm_empty_view_remove_file (FMDirectoryView *view, ScatolaFile *file, ScatolaDirectory *directory)
{
    FM_EMPTY_VIEW (view)->details->number_of_files--;
...
static int
fm_empty_view_compare_files (FMDirectoryView *view, ScatolaFile *file1, ScatolaFile *file2)
{
    if (file1 < file2)
    {
        return -1;
...
static char *
fm_empty_view_get_first_visible_file (ScatolaView *view)
{
    return NULL;
}

static void
fm_empty_view_scroll_to_file (ScatolaView *view,
                              const char *uri)
{
}

static void
fm_empty_view_grab_focus (ScatolaView *view)
{
...
static const char *
fm_empty_view_get_id (ScatolaView *view)
{
...
static void
fm_empty_view_iface_init (ScatolaViewIface *iface)
{
...
static ScatolaView *
fm_empty_view_create (ScatolaWindowSlotInfo *slot)
{
    FMEmptyView *view;
...
static ScatolaViewInfo fm_empty_view =
{
    FM_EMPTY_VIEW_ID,
    "Empty",
    "Empty View",
...
fm_empty_view_register (void)
{
    ...
    scatola_view_factory_register (&fm_empty_view);
}
