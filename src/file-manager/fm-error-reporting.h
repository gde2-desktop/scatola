...
void fm_report_error_loading_directory	 (ScatolaFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_renaming_file       (ScatolaFile   *file,
        const char     *new_name,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_permissions (ScatolaFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_owner       (ScatolaFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_group       (ScatolaFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);

/* FIXME bugzilla.gnome.org 42394: Should this file be renamed or should this function be moved? */
void fm_rename_file                      (ScatolaFile   *file,
        const char     *new_name,
