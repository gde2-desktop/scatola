...
/* scatola-self-check-functions.h: Wrapper and prototypes for all self
 * check functions in Scatola proper.
 */
...
#define SCATOLA_FOR_EACH_SELF_CHECK_FUNCTION(macro) \
/* Add new self-check functions to the list above this line. */

/* Generate prototypes for all the functions. */
SCATOLA_FOR_EACH_SELF_CHECK_FUNCTION (SCATOLA_SELF_CHECK_FUNCTION_PROTOTYPE)
