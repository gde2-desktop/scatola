...
struct ScatolaEmblemSidebarDetails
{
...
static void scatola_emblem_sidebar_populate          (ScatolaEmblemSidebar        *emblem_sidebar);
static void scatola_emblem_sidebar_refresh           (ScatolaEmblemSidebar        *emblem_sidebar);
static void scatola_emblem_sidebar_iface_init        (ScatolaSidebarIface         *iface);
static void sidebar_provider_iface_init           (ScatolaSidebarProviderIface *iface);
static GType scatola_emblem_sidebar_provider_get_type (void);
...
{
    GObject parent;
} ScatolaEmblemSidebarProvider;

typedef struct
{
    GObjectClass parent;
} ScatolaEmblemSidebarProviderClass;

#if GTK_CHECK_VERSION (3, 0, 0)
G_DEFINE_TYPE_WITH_CODE (ScatolaEmblemSidebar, scatola_emblem_sidebar, GTK_TYPE_BOX,
#else
G_DEFINE_TYPE_WITH_CODE (ScatolaEmblemSidebar, scatola_emblem_sidebar, GTK_TYPE_VBOX,
#endif
                         G_IMPLEMENT_INTERFACE (SCATOLA_TYPE_SIDEBAR,
                                 scatola_emblem_sidebar_iface_init));

G_DEFINE_TYPE_WITH_CODE (ScatolaEmblemSidebarProvider, scatola_emblem_sidebar_provider, G_TYPE_OBJECT,
                         G_IMPLEMENT_INTERFACE (SCATOLA_TYPE_SIDEBAR_PROVIDER,
                                 sidebar_provider_iface_init));

static void
scatola_emblem_sidebar_drag_data_get_cb (GtkWidget *widget,
                                      GdkDragContext *context,
                                      GtkSelectionData *data,
                                      guint info,
                                      guint time,
                                      ScatolaEmblemSidebar *emblem_sidebar)
{
    char *keyword;
...
static void
scatola_emblem_sidebar_enter_notify_cb (GtkWidget *widget,
                                     ScatolaEmblemSidebar *emblem_sidebar)
{
    GdkPixbuf *pixbuf;
...
static void
scatola_emblem_sidebar_leave_notify_cb (GtkWidget *widget,
                                     ScatolaEmblemSidebar *emblem_sidebar)
{
    GdkPixbuf *pixbuf;
    EelLabeledImage *image;
...
static gboolean
scatola_emblem_sidebar_button_press_cb (GtkWidget *widget,
                                     ...
                                     ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    if (event->button == 3)
    {
        ...
        gtk_widget_set_sensitive (emblem_sidebar->details->popup_remove,
                                  scatola_emblem_can_remove_emblem (keyword));
        gtk_widget_set_sensitive (emblem_sidebar->details->popup_rename,
                                  scatola_emblem_can_rename_emblem (keyword));
...
emblems_changed_callback (GObject *signaller,
                          ScatolaEmblemSidebar *emblem_sidebar)
{
    scatola_emblem_sidebar_refresh (emblem_sidebar);
}

static void
scatola_emblem_sidebar_delete_cb (GtkWidget *menu_item,
                               ScatolaEmblemSidebar *emblem_sidebar)
{
    char *error;

    if (scatola_emblem_remove_emblem (emblem_sidebar->details->popup_emblem_keyword))
    {
                           ...
                           ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    if (scatola_emblem_rename_emblem (keyword, name))
    {
        send_emblems_changed ();
    }
    else
...
static GtkWidget *
create_rename_emblem_dialog (ScatolaEmblemSidebar *emblem_sidebar,
...
static void
scatola_emblem_sidebar_rename_cb (GtkWidget *menu_item,
                               ScatolaEmblemSidebar *emblem_sidebar)
{
    GtkWidget *dialog;
...
static void
create_popup_menu (ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    g_signal_connect (menu_item, "activate",
                      G_CALLBACK (scatola_emblem_sidebar_rename_cb),
                      emblem_sidebar);
    ...
    menu_item = gtk_image_menu_item_new_from_stock (GTK_STOCK_DELETE,
                NULL);
    g_signal_connect (menu_item, "activate",
                      G_CALLBACK (scatola_emblem_sidebar_delete_cb),
                      emblem_sidebar);
    gtk_widget_show (menu_item);
    gtk_menu_shell_append (GTK_MENU_SHELL (popup), menu_item);
...
static GtkWidget *
create_emblem_widget_with_pixbuf (ScatolaEmblemSidebar *emblem_sidebar,
                                  const char *keyword,
                                  ...
                                  GdkPixbuf *pixbuf)
{
    ...
    g_signal_connect (event_box, "button_press_event",
                      G_CALLBACK (scatola_emblem_sidebar_button_press_cb),
                      emblem_sidebar);
    g_signal_connect (event_box, "drag-data-get",
                      G_CALLBACK (scatola_emblem_sidebar_drag_data_get_cb),
                      emblem_sidebar);
    g_signal_connect (event_box, "enter-notify-event",
                      G_CALLBACK (scatola_emblem_sidebar_enter_notify_cb),
                      emblem_sidebar);
    g_signal_connect (event_box, "leave-notify-event",
                      G_CALLBACK (scatola_emblem_sidebar_leave_notify_cb),
                      emblem_sidebar);
...
static GtkWidget *
create_emblem_widget (ScatolaEmblemSidebar *emblem_sidebar,
                      const char *name)
{
    GtkWidget *ret;
    const char *display_name;
    ...
    info = scatola_icon_info_lookup_from_name (name, SCATOLA_ICON_SIZE_STANDARD);

    pixbuf = scatola_icon_info_get_pixbuf_at_size (info, SCATOLA_ICON_SIZE_STANDARD);

    display_name = scatola_icon_info_get_display_name (info);

    keyword = scatola_emblem_get_keyword_from_icon_name (name);
...
static GtkWidget *
create_add_emblems_dialog (ScatolaEmblemSidebar *emblem_sidebar,
                           GSList *emblems)
{
...
static void
scatola_emblem_sidebar_refresh (ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    scatola_emblem_sidebar_populate (emblem_sidebar);
}
                                ...
                                ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    case GTK_RESPONSE_OK:
        ...
        for (l = emblems; l; l = l->next)
        {
            ...
            keyword = scatola_emblem_create_unique_keyword (emblem->name);
            if (!scatola_emblem_verify_keyword
        ...
        for (l = emblems; l; l = l->next)
        {
            ...
            scatola_emblem_install_custom_emblem (emblem->pixbuf,
                                               emblem->keyword,
                                               emblem->name,
                                               GTK_WINDOW (dialog));
        }
...
static void
show_add_emblems_dialog (ScatolaEmblemSidebar *emblem_sidebar,
                         GSList *emblems)
{
    GtkWidget *dialog;
...
static void
scatola_emblem_sidebar_drag_received_cb (GtkWidget *widget,
                                      ...
                                      ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    case TARGET_URI_LIST:
        ...
        for (i = 0; uris[i] != NULL; ++i)
        {
            ...
            pixbuf = scatola_emblem_load_pixbuf_for_emblem (f);
...
static GtkWidget *
scatola_emblem_sidebar_create_container (ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    g_signal_connect (scroller, "drag-data-received",
                      G_CALLBACK (scatola_emblem_sidebar_drag_received_cb),
                      emblem_sidebar);
...
static void
scatola_emblem_sidebar_populate (ScatolaEmblemSidebar *emblem_sidebar)
{
    ...
    path = scatola_pixmap_file ("erase.png");
    if (path != NULL)
    {
    ...
    while (l != NULL)
    {
        ...
        if (!scatola_emblem_should_show_in_list (name))
        {
            continue;
        }
...
static void
scatola_emblem_sidebar_init (ScatolaEmblemSidebar *emblem_sidebar)
{
    GtkWidget *widget;

    emblem_sidebar->details = g_new0 (ScatolaEmblemSidebarDetails, 1);

    create_popup_menu (emblem_sidebar);

    widget = scatola_emblem_sidebar_create_container (emblem_sidebar);
    scatola_emblem_sidebar_populate (emblem_sidebar);
...
static void
scatola_emblem_sidebar_finalize (GObject *object)
{
    ScatolaEmblemSidebar *emblem_sidebar;

    g_assert (SCATOLA_IS_EMBLEM_SIDEBAR (object));
    emblem_sidebar = SCATOLA_EMBLEM_SIDEBAR (object);
    ...
    G_OBJECT_CLASS (scatola_emblem_sidebar_parent_class)->finalize (object);
}

static void
scatola_emblem_sidebar_class_init (ScatolaEmblemSidebarClass *object_klass)
{
    GObjectClass *gobject_class;

    ScatolaEmblemSidebarClass *klass;

    klass = SCATOLA_EMBLEM_SIDEBAR_CLASS (object_klass);
    gobject_class = G_OBJECT_CLASS (object_klass);

    gobject_class->finalize = scatola_emblem_sidebar_finalize;
}

static const char *
scatola_emblem_sidebar_get_sidebar_id (ScatolaSidebar *sidebar)
{
    return SCATOLA_EMBLEM_SIDEBAR_ID;
}

static char *
scatola_emblem_sidebar_get_tab_label (ScatolaSidebar *sidebar)
{
    return g_strdup (_("Emblems"));
}

static char *
scatola_emblem_sidebar_get_tab_tooltip (ScatolaSidebar *sidebar)
{
    return g_strdup (_("Show Emblems"));
}

static GdkPixbuf *
scatola_emblem_sidebar_get_tab_icon (ScatolaSidebar *sidebar)
{
    return NULL;
}

static void
scatola_emblem_sidebar_is_visible_changed (ScatolaSidebar *sidebar,
                                        gboolean         is_visible)
{
    /* Do nothing */
}
...
static void
scatola_emblem_sidebar_iface_init (ScatolaSidebarIface *iface)
{
    iface->get_sidebar_id = scatola_emblem_sidebar_get_sidebar_id;
    iface->get_tab_label = scatola_emblem_sidebar_get_tab_label;
    iface->get_tab_tooltip = scatola_emblem_sidebar_get_tab_tooltip;
    iface->get_tab_icon = scatola_emblem_sidebar_get_tab_icon;
    iface->is_visible_changed = scatola_emblem_sidebar_is_visible_changed;
}

static void
scatola_emblem_sidebar_set_parent_window (ScatolaEmblemSidebar *sidebar,
                                       ScatolaWindowInfo *window)
{
...
scatola_emblem_sidebar_create (ScatolaSidebarProvider *provider,
                            ScatolaWindowInfo *window)
{
    ScatolaEmblemSidebar *sidebar;

    sidebar = g_object_new (scatola_emblem_sidebar_get_type (), NULL);
    scatola_emblem_sidebar_set_parent_window (sidebar, window);
...
{
    iface->create = scatola_emblem_sidebar_create;
}

static void
scatola_emblem_sidebar_provider_init (ScatolaEmblemSidebarProvider *sidebar)
{
}

static void
scatola_emblem_sidebar_provider_class_init (ScatolaEmblemSidebarProviderClass *class)
{
}

void
scatola_emblem_sidebar_register (void)
{
    scatola_module_add_type (scatola_emblem_sidebar_provider_get_type ());
}
