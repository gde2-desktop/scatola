...
/* scatola-keep-last-vertical-box.c: Subclass of GtkBox that clips off
...
#include <config.h>
#include "scatola-keep-last-vertical-box.h"

static void     scatola_keep_last_vertical_box_class_init  (ScatolaKeepLastVerticalBoxClass *class);
static void     scatola_keep_last_vertical_box_init        (ScatolaKeepLastVerticalBox      *box);
static void	scatola_keep_last_vertical_box_size_allocate 	  (GtkWidget 			    *widget,
        GtkAllocation 		    *allocation);

G_DEFINE_TYPE (ScatolaKeepLastVerticalBox, scatola_keep_last_vertical_box, GTK_TYPE_BOX)

#define parent_class scatola_keep_last_vertical_box_parent_class

/* Standard class initialization function */
static void
scatola_keep_last_vertical_box_class_init (ScatolaKeepLastVerticalBoxClass *klass)
{
    GtkWidgetClass *widget_class;

    widget_class = (GtkWidgetClass *) klass;

    widget_class->size_allocate = scatola_keep_last_vertical_box_size_allocate;
}

/* Standard object initialization function */
static void
scatola_keep_last_vertical_box_init (ScatolaKeepLastVerticalBox *box)
{
    gtk_orientable_set_orientation (GTK_ORIENTABLE (box), GTK_ORIENTATION_VERTICAL);
}


/* scatola_keep_last_vertical_box_new:
 *
 ...
 *
 * Return value: A new ScatolaKeepLastVerticalBox
 */
GtkWidget *
scatola_keep_last_vertical_box_new (gint spacing)
{
    ScatolaKeepLastVerticalBox *box;

    box = SCATOLA_KEEP_LAST_VERTICAL_BOX (gtk_widget_new (scatola_keep_last_vertical_box_get_type (), NULL));
...
static void
scatola_keep_last_vertical_box_size_allocate (GtkWidget *widget,
        GtkAllocation *allocation)
{
    GtkBox *box;
    ...
    g_return_if_fail (SCATOLA_IS_KEEP_LAST_VERTICAL_BOX (widget));
    g_return_if_fail (allocation != NULL);

    GTK_WIDGET_CLASS (scatola_keep_last_vertical_box_parent_class)->size_allocate (widget, allocation);
