/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   scatola-emblem-utils.c: Utilities for handling emblems
...
#include "scatola-emblem-utils.h"
...
GList *
scatola_emblem_list_available (void)
{
...
void
scatola_emblem_refresh_list (void)
{
    GtkIconTheme *icon_theme;
...
char *
scatola_emblem_get_icon_name_from_keyword (const char *keyword)
{
...
is_reserved_keyword (const char *keyword)
{
    ...
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_TRASH) == 0)
    {
        return TRUE;
    }
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_CANT_READ) == 0)
    {
        return TRUE;
    }
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_CANT_WRITE) == 0)
    {
        return TRUE;
    }
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_SYMBOLIC_LINK) == 0)
    {
        return TRUE;
    }
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_NOTE) == 0)
    {
        return TRUE;
    }
    if (g_ascii_strcasecmp (keyword, SCATOLA_FILE_EMBLEM_NAME_SHARED) == 0)
    {
        return TRUE;
    }

    available = scatola_emblem_list_available ();
    icon_name = scatola_emblem_get_icon_name_from_keyword (keyword);
...
gboolean
scatola_emblem_should_show_in_list (const char *emblem)
{
...
char *
scatola_emblem_get_keyword_from_icon_name (const char *emblem)
{
...
GdkPixbuf *
scatola_emblem_load_pixbuf_for_emblem (GFile *emblem)
{
    GInputStream *stream;
    GdkPixbuf *pixbuf;
    GdkPixbuf *scaled;
...
gboolean
scatola_emblem_verify_keyword (GtkWindow *parent_window,
                            const char *keyword,
...
void
scatola_emblem_install_custom_emblem (GdkPixbuf *pixbuf,
                                   const char *keyword,
                                   const char *display_name,
                                   GtkWindow *parent_window)
{
    ...
    if (!scatola_emblem_verify_keyword (parent_window, keyword, display_name))
    {
        return;
    }
...
gboolean
scatola_emblem_can_remove_emblem (const char *keyword)
{
    char *path;
    gboolean ret = TRUE;
...
gboolean
scatola_emblem_can_rename_emblem (const char *keyword)
{
    char *path;
    gboolean ret = TRUE;
...
gboolean
scatola_emblem_remove_emblem (const char *keyword)
{
...
gboolean
scatola_emblem_rename_emblem (const char *keyword, const char *name)
{
    ...
    icon_name = scatola_emblem_get_icon_name_from_keyword (keyword);
    scatola_icon_info_clear_caches (); /* A bit overkill, but this happens rarely */
...
char *
scatola_emblem_create_unique_keyword (const char *base)
{
    char *keyword;
    time_t t;
    int i;
