...
scatola_recent_get_manager (void)
{
...
void
scatola_recent_add_file (ScatolaFile *file,
                      GAppInfo *application)
{
    ...
    recent_data.mime_type = scatola_file_get_mime_type (file);
    ...
    gtk_recent_manager_add_full (scatola_recent_get_manager (),
                                 uri, &recent_data);
