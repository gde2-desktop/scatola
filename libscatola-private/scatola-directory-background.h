...
/*
   scatola-directory-background.h: Helper for the background of a widget
...
void     scatola_connect_background_to_file_metadata    (GtkWidget         *widget,
                                                      ScatolaFile          *file,
                                                      GdkDragAction      default_drag_action);

void     scatola_connect_desktop_background_to_settings (ScatolaIconContainer *icon_container);
