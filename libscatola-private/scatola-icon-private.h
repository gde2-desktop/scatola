...
#ifndef SCATOLA_ICON_CONTAINER_PRIVATE_H
#define SCATOLA_ICON_CONTAINER_PRIVATE_H

#include <eel/eel-glib-extensions.h>
#include <libscatola-private/scatola-icon-canvas-item.h>
...
/* Private ScatolaIconContainer members. */
...
struct ScatolaIconContainerDetails
{
    /* List of icons. */
    GList *icons;
    GList *new_icons;
    ...
    ScatolaIcon *keyboard_icon_to_reveal;
    ...
    ScatolaIcon *double_click_icon[2]; /* Both clicks in a double click need to be on the same icon */
    guint double_click_button[2];

    ScatolaIcon *range_selection_base_icon;
    ...
    int font_size_table[SCATOLA_ZOOM_LEVEL_LARGEST + 1];
    ...
    /* Layout mode */
    ScatolaIconLayoutMode layout_mode;

    /* Label position */
    ScatolaIconLabelPosition label_position;
...
ScatolaIcon *scatola_icon_container_get_icon_by_uri             (ScatolaIconContainer *container,
        const char            *uri);
void          scatola_icon_container_move_icon                   (ScatolaIconContainer *container,
        ScatolaIcon          *icon,
        int                    x,
        int                    y,
        double                 scale,
...
void          scatola_icon_container_select_list_unselect_others (ScatolaIconContainer *container,
        GList                 *icons);
char *        scatola_icon_container_get_icon_uri                (ScatolaIconContainer *container,
        ScatolaIcon          *icon);
char *        scatola_icon_container_get_icon_drop_target_uri    (ScatolaIconContainer *container,
        ScatolaIcon          *icon);
void          scatola_icon_container_update_icon                 (ScatolaIconContainer *container,
        ScatolaIcon          *icon);
gboolean      scatola_icon_container_has_stored_icon_positions   (ScatolaIconContainer *container);
gboolean      scatola_icon_container_emit_preview_signal         (ScatolaIconContainer *view,
        ScatolaIcon          *icon,
        gboolean               start_flag);
gboolean      scatola_icon_container_scroll                      (ScatolaIconContainer *container,
        int                    delta_x,
        int                    delta_y);
void          scatola_icon_container_update_scroll_region        (ScatolaIconContainer *container);

#if !GTK_CHECK_VERSION(3,0,0)
/* label color for items */
void          scatola_icon_container_get_label_color             (ScatolaIconContainer *container,
        GdkColor             **color,
        gboolean               first_line,
...
#endif /* SCATOLA_ICON_CONTAINER_PRIVATE_H */
