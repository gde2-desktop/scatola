...
typedef GObject ScatolaSignaller;
typedef GObjectClass ScatolaSignallerClass;
...
static GType scatola_signaller_get_type (void);

G_DEFINE_TYPE (ScatolaSignaller, scatola_signaller, G_TYPE_OBJECT);

GObject *
scatola_signaller_get_current (void)
{
    static GObject *global_signaller = NULL;

    if (global_signaller == NULL)
    {
        global_signaller = g_object_new (scatola_signaller_get_type (), NULL);
...
static void
scatola_signaller_init (ScatolaSignaller *signaller)
{
}

static void
scatola_signaller_class_init (ScatolaSignallerClass *class)
{
