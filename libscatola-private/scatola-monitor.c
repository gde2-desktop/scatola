/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   scatola-monitor.c: file and directory change monitoring for scatola
...
#include <config.h>
#include "scatola-monitor.h"
#include "scatola-file-changes-queue.h"
#include "scatola-file-utilities.h"

#include <gio/gio.h>

struct ScatolaMonitor
{
    GFileMonitor *monitor;
};

gboolean
scatola_monitor_active (void)
{
             ...
             gpointer user_data)
{
    ...
    case G_FILE_MONITOR_EVENT_CHANGES_DONE_HINT:
        scatola_file_changes_queue_file_changed (child);
        break;
    case G_FILE_MONITOR_EVENT_DELETED:
        scatola_file_changes_queue_file_removed (child);
        break;
    case G_FILE_MONITOR_EVENT_CREATED:
        scatola_file_changes_queue_file_added (child);
        break;
...
ScatolaMonitor *
scatola_monitor_directory (GFile *location)
{
    GFileMonitor *dir_monitor;
    ScatolaMonitor *ret;
...
void
scatola_monitor_cancel (ScatolaMonitor *monitor)
{
